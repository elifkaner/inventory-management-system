            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                    <p className="text-sm text-slate-700">
                        Toplam <span className="font-semibold text-slate-900">{totalCount}</span> kayıttan{' '}
                        <span className="font-semibold text-slate-900">{(currentPage - 1) * pageSize + 1}</span>-
                        <span className="font-semibold text-slate-900">{Math.min(currentPage * pageSize, totalCount)}</span> arası gösteriliyor.
                    </p>
                    <div className="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        <select
                            ...
                            className="border-slate-300 text-slate-700 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 bg-slate-50 py-1 pl-2 pr-8 cursor-pointer"
                        >
