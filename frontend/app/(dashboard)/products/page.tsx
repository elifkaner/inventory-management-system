                ...
                <table className="w-full text-left border-collapse table-auto">
                    <thead>
                        <tr className="bg-slate-50/70 dark:bg-slate-800/80 border-b border-slate-100 dark:border-slate-700 text-slate-400 dark:text-slate-500 text-xs font-bold tracking-wider">
                            ...
                            <th className="px-3 py-3 whitespace-nowrap min-w-[120px]">SKU Kodu</th>
                            <th className="px-3 py-3 whitespace-nowrap min-w-[140px]">Barkod</th>
                ...
                <div className="fixed inset-0 z-[70] overflow-y-auto bg-slate-900/50 backdrop-blur-sm">
                    <div className="flex items-center justify-center min-h-screen p-4">
                        <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-slate-800 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] w-full max-w-4xl relative transition-colors">
                            ...
                            <div className="px-8 py-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50 rounded-t-3xl border-0">
