...
{
    Task<PagedResult<Product>> GetAllAsync(string? search = null, int? categoryId = null, int? brandId = null, int? modelId = null, int? supplierId = null, bool? isActive = null, int? page = null, int? pageSize = null);
