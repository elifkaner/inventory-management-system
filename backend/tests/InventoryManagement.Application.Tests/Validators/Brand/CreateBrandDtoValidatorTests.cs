...
{
    private readonly CreateBrandDtoValidator _validator = new();
    ...
    {
        // Given
        var dto = new CreateBrandDto { Name = new string('a', 101) };
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.Name);
    ...
    {
        // Given
        var dto = new CreateBrandDto { Name = new string('a', 100) };
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateBrandDto { Name = "Apple" };
        // When
        var result = _validator.TestValidate(dto);
        // Then
