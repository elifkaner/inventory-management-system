...
public class CreateSupplierDtoValidatorTests
{
    ...
    {
        // Given
        var dto = new CreateSupplierDto {CompanyName = ""};
        // When
    ...
    {
        // Given
        var dto = new CreateSupplierDto {CompanyName = new string('a',151)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.CompanyName);
    ...
    {
        // Given
        var dto = new CreateSupplierDto {CompanyName = new string('a',150)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {ContactPerson = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {ContactPerson = new string('a',101)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.ContactPerson);
    ...
    {
        // Given
        var dto = new CreateSupplierDto {ContactPerson = new string('a',100)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Phone = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        var dto = new CreateSupplierDto { Phone = invalidPhone };
        var result = _validator.TestValidate(dto);
        result.ShouldHaveValidationErrorFor(x => x.Phone);
    }
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Email = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Email = "gecersizmail"};
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.Email);
    ...
    {
        // Given
        var dto = new CreateSupplierDto {TaxOffice = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {TaxOffice = new string('a',101)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.TaxOffice);
    ...
    {
        // Given
        var dto = new CreateSupplierDto {TaxOffice = new string('a',100)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {TaxNumber = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        var dto = new CreateSupplierDto { TaxNumber = invalidTaxNumber };
        var result = _validator.TestValidate(dto);
        result.ShouldHaveValidationErrorFor(x => x.TaxNumber);
    }
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Address = ""};
        // When
        var result = _validator.TestValidate(dto);
        // Then
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Address = new string('a',251)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
        result.ShouldHaveValidationErrorFor(x => x.Address);
    ...
    {
        // Given
        var dto = new CreateSupplierDto {Address = new string('a',250)};
        // When
        var result = _validator.TestValidate(dto);
        // Then
